...
interface
	...
	procedure olahBahan ( var invenmentah : InvMentah ; var involah : InvOlahan ; var olah : Olahan ; t : tanggal ; var uang : longint; var energi : longint);
	...
	procedure olahBahan ( var invenmentah : InvMentah ; var involah : InvOlahan ; var olah : Olahan ; t : tanggal ; var uang : longint; var energi : longint);
		...
		begin
			if ( energi = 0 ) then
				...
				if ( sama = true ) then
					begin
						involah.TabInvOlahan[max].TglBuat := t; // belum ada tanggal
