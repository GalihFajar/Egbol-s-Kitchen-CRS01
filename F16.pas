...
interface
  uses tipe;
  procedure tambahResep(x : InvMentah; y : InvOlahan ;var masukan : resepnya); //Prosedur utama menambah resep.
  procedure TambahBahan(max: integer;batas : integer;x : InvMentah; y : InvOlahan; var masukan : resepnya); //Prosedur menambah bahan mentah.
...
implementation
  ...
  procedure TambahBahan(max: integer;batas : integer;x : InvMentah; y : InvOlahan; var masukan : resepnya);
    var
      i : integer;
    begin
      for i := 1 to batas do
  ...
  procedure tambahResep(x : InvMentah; y : InvOlahan ;var masukan : resepnya);
    var
      max : integer;
    begin
